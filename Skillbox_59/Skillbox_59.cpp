...
int main() 
{
	...
	// Задаем начальные параметры орка
	double health;
	...
	{
		cout << "Ошибка ввода. Пожалуйста, введите значения от 0 до 1." << endl;
		return 1; // Код ошибки
	}
	...
	while (health > 0) 
	{
		// Вводим мощность огненного шара
		double spellPower;
		...
		{
			cout << "Ошибка ввода. Пожалуйста, введите значение от 0 до 1." << endl;
			continue; // Переход на следующую итерацию цикла
		}

		// Вычисляем урон с учетом сопротивляемости магии
		double damage = spellPower * (1 - magicResistance);

		// Уменьшаем здоровье орка
		health -= damage;

		// Выводим результат
		cout << "Нанесен урон: " << damage << endl;
		cout << "Остаток здоровья орка: " << health << endl;
	}
